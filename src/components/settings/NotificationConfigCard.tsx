    ...
    <Card>
      ...
      <form onSubmit={handleSave}>
        <CardContent className="grid gap-4">
          ...
          {/* Subscription Cron */}
          <div className="grid gap-2">
            <Label htmlFor="config-notification.subscription-crontab">
              {t("settings.notification.fields.subscriptionCrontab")}
            </Label>
            <input
              ...
              placeholder={t(
                "settings.notification.placeholders.subscriptionCrontab",
              )}
              className="flex h-9 w-full rounded-md border border-input bg-background px-3 py-1 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
            />
          </div>
          ...
          {/* Archives Cron */}
          <div className="grid gap-2">
            <Label htmlFor="config-notification.archives-crontab">
              {t("settings.notification.fields.archivesCrontab")}
            </Label>
            <input
